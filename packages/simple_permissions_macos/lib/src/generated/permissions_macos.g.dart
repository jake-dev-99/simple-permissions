...
class PermissionsMacosHostApi {
  /// Constructor for [PermissionsMacosHostApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  PermissionsMacosHostApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<String> checkPermission(String identifier) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.checkPermission$pigeonVar_messageChannelSuffix';
  ...
  Future<String> requestPermission(String identifier) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.requestPermission$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<bool> isSupported(String identifier) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.isSupported$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<bool> openAppSettings() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.openAppSettings$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
