...
class PermissionsMacosHostApi {
  ...
  Future<String> checkPermission(String identifier) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.checkPermission$pigeonVar_messageChannelSuffix';
  ...
  Future<String> requestPermission(String identifier) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.requestPermission$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<bool> isSupported(String identifier) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.isSupported$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<bool> openAppSettings() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.openAppSettings$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<String> checkLocationAccuracy() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.simple_permissions_macos.PermissionsMacosHostApi.checkLocationAccuracy$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
